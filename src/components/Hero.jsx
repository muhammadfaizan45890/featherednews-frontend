  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 
          CHANGES MADE:
          - Removed `rounded` from the image span.
          - Reduced gap: base `gap-0.5`, xs `gap-1`, sm `gap-1.5`, md `gap-2`.
          - Reduced padding: base `pr-1`, xs `pr-1.5`, sm `pr-2` (from pr-1.5, pr-2, pr-3).
        */}
        <div className="flex gap-0.5 xs:gap-1 sm:gap-1.5 md:gap-2 mt-2 md:mt-3 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
